...
#
#  This code no longer works because both Google and Yahoo have
#  discontinued the relevant services
#
#
#
...
$q = new Finance::QuoteHist::Google(%query) or die "Cannot issue query\n";
